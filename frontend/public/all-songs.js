document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchAndRenderSongs() {
        try {
            ...
            if (songs.length === 0) {
                container.innerHTML =
                    '<p id="loading-text">No songs found in the database yet.</p>'
                return
            }
            ...
            songs.forEach((song) => {
                ...
                card.href = `lyrics.html?song_id=${song.song_id}`
            ...
            container.innerHTML =
                '<p id="loading-text" style="color: red;">Failed to load songs. Is the backend running?</p>'
        }
    }
